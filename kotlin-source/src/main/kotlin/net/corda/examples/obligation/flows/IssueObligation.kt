...
object IssueObligation {
    ...
    class Initiator(private val amount: Amount<Currency>,
                    ...
                    private val remark: String = "") : ObligationBaseFlow() {
        ...
        private fun createAnonymousObligation(lenderSession: FlowSession): Obligation {
            ...
            return Obligation(amount, anonymousIdentitiesResult.theirIdentity, anonymousIdentitiesResult.ourIdentity, anonymousMe, remark = remark)
        }
    }
